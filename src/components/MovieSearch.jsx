  ...
  return (
    <div className='movie-search'>
      ...
      <p className='search-description'>
        Dive into our collection of dystopian worlds and bleak futures. Discover
        films that explore the dark side of technology, society, and human
        nature.
      </p>
              ...
              <div key={movie.imdbID} className='movie-card'>
                <div className='movie-poster'>
                  {movie.Poster && movie.Poster !== 'N/A' ? (
                    ...
                    <div className='no-poster'>No Visuals Available</div>
                  )}
                </div>
